...
| [Grouped Strata Simulation](dsims-grouped-strata/dsims_grouped_strata.html) ([Rmd](dsims-grouped-strata/dsims_grouped_strata.Rmd)) |  Simulations using grouped strata for analysis when the region has been divided into sub-strata for design optimisation. | simulation, grouped strata | Simulation |
