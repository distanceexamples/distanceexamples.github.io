...
| Simulation design contrasts (Rmd) | *Currently being revised from using DSsim to dsims, back online by August 31st 2022*Simulation package evaluates randomised and non-randomised surveys designs when animals avoid human trails. | design, randomisation | Simulation | XXXX |
